...
public class CheckerGUI extends JFrame implements ActionListener{
	...
	// add all previously defined JButtons to squaresMatrix so we can access all of them through squaresMatrix
	...
	for (int i = 0; i < 8; i++) {
		...
		allSquares[i][j].setActionCommand(String.valueOf(i+j));
